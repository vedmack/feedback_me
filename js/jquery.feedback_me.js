...
* custom_message
				...
				Type:				String
				Default value:		""
				Description:		Allows you to provide a custom message above the form and below the title. Message will be inside a feedback_message widget
* custom_html
				Required:			false
				Type:				String
				Default value:		""
...
var fm = (function ($) {
    ...
    function appendFeedbackToBody(fm_options) {
        ...
        if (fm_options.custom_message !== undefined) {
            custom_message = '<div class="feedback_message">' + fm_options.custom_message + '</div>';
        }
            ...
            success: function (data) {
                ...
                if (fm_options.delayed_close === true) {
                    if (fm_options.delayed_options.custom_html_success === undefined) {
                        ...
                        setTimeout(function () {
                            $(".feedback-delayed-dlg").fadeOut(function () {
                                $(this).remove();
                            });
                        }, fm_options.delayed_options.delay_success_milliseconds);
                    } else {
                        $fm_content.find('.feedback_submit').text(fm_options.submit_label);
                        slideBack(fm_options, $fm_trigger, $fm_content);
                        ...
                        setTimeout(function () {
                            $(".feedback-delayed-custom-dlg").fadeOut(function () {
                                $(this).remove();
                            });
                        }, fm_options.delayed_options.delay_success_milliseconds);
                    }
            ...
            error: function (ob, errStr) {
                ...
                if (fm_options.delayed_close === true) {
                    if (fm_options.delayed_options.custom_html_fail === undefined) {
                        ...
                        }, fm_options.delayed_options.delay_fail_milliseconds);
                    } else {
                        $fm_content.find('.feedback_submit').text(fm_options.submit_label);
